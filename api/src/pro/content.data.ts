...
// Converted verbatim from supabase/seed/pro_content_seed.sql (pro_content rows, titles from
// the matching pro_catalog rows on (topic_id, position)). Mechanical data transcription — do
// not edit the content bodies by hand; regenerate from the seed if content changes.
